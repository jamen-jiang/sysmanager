...
export default {
    ...
    methods: {
        select(id){
            ...
            this.$store.commit('get_menus', this.menuTree);
        },
        selecthome(){
            this.$router.push({path:'/'})
            this.$store.commit('get_menus', []);
        },
        toggle(){
            this.$store.commit('set_MenuCollapse',!this.isCollapse)
        }
    },
    components: {
...
<style scoped>
    ...
    #header .el-menu--horizontal>.el-menu-item.is-active,#header .el-menu--horizontal .el-menu-item:hover{
        border-bottom: 0px;
        color: #409EFF;
    ...
    /* 下面的样式可以单独写，然后引入 */ 
    @font-face { /* Unicode  */   font-family: "iconfont";   src: url("../assets/iconfont/iconfont.eot");   src:url("../assets/iconfont/iconfont.eot?#iefix")format("embedded-opentype"),
